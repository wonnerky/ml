...
# x = noise input / n_hidden = MLP hidden(500) / n_output = dim_z / keep_prob = drop_out
...
# z = sampling value / n_hidden = MLP hidden(500) / n_output = dim_img(28*28) / keep_prob = drop_out
